...
const skills = [
    ...
    { name: "React", isSvg: false, icon: "fa-brands fa-react", color: "text-cyan-400" },
    {
        ...
        isSvg: true,
        svgContent: (
            <svg className="mr-2 h-4 w-4 text-[#38bdf8]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: "BootStrap", isSvg: false, icon: "fa-brands fa-bootstrap", color: "text-purple-600" },
    {
        ...
        isSvg: true,
        svgContent: (
            <svg className="mr-2 h-4 w-4" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
